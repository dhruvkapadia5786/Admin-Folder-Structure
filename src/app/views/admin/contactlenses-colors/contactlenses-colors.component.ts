...
import { ContactLensesColorAddEditModalService } from '../contactlenses-color-add-edit-modal/contactlenses-color-add-edit-modal.service';

@Component({
  selector: 'app-contactlenses-colors',
  templateUrl: './contactlenses-colors.component.html',
  styleUrls: ['./contactlenses-colors.component.scss']
})
export class ContactlensesColorsComponent implements OnInit,AfterViewInit,OnDestroy {
  modalRef!: BsModalRef;
  TableData = [];
  ...
  constructor(
    ...
    private _brandService:ContactlensesColorsService,
    private _colorAddEditModalService:ContactLensesColorAddEditModalService){
      this.getDTOptions();
  }
  ...
  openAddModal(){
    this._colorAddEditModalService.setData({event:'ADD'})
    this.modalRef = this.modalService.show(ContactlensesColorAddEditModalComponent,{class:'modal-lg'});
  ...
  openEditModal(id:any){
    ...
    this._colorAddEditModalService.setData({event:'EDIT',data:data});
    this.modalRef = this.modalService.show(ContactlensesColorAddEditModalComponent,{class:'modal-lg'});
    this.modalRef.content.onEventCompleted.subscribe(()=>{
      this.rerender();
    });
