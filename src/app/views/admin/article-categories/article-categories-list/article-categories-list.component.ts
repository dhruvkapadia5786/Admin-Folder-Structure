...
export class  ArticleCategoriesListComponent implements OnInit, AfterViewInit, OnDestroy {
  modalRef!: BsModalRef;
  ...
  goToDetailsPage(categoryId: any): any {
    this.router.navigate(['admin', 'article-categories', 'view', categoryId]);
  }
  ...
  getDTOptions() {
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this._http
          .post<any>(
            'api/admin/article_categories/list',
