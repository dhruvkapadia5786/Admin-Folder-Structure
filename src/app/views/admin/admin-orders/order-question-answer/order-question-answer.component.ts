...
export class OrderQuestionAnswerComponent implements OnInit {
  ...
  private _getAlardyFillDrugsByUser() {
    this.selectDrug = [];
    const url = 'api/orders/getUserOrderDrugs?user_id=' + this.patient.id;
  ...
  private _getUserIllnesses() {
    const url = 'api/orders/getUserOrderIllnesses?user_id=' + this.patient.id;
    this.http.post(url, { order_id: this.orderId }).subscribe(
      (data: any) => {
        if (data) {
  ...
  private _getUserAllergies() {
    const url = 'api/orders/getUserOrderAllergies?user_id=' + this.patient.id;
    this.http.post(url, { order_id: this.orderId }).subscribe(
      (data: any) => {
        if (data) {
  ...
  sendConsent(formValid: boolean, modal: any) {
    if (formValid) {
      ...
      if (eventName == 'QUESTION') {
        ...
        api_url = 'api/orders/userDrugs/sendConsent';
        req = {
        ...
        api_url = 'api/orders/userIllnesses/sendConsent';
        req = {
          user_id: this.patient.id,
          order_id: this.orderId,
          consent_message: this.consentForm.value.consentMsg
        ...
        api_url = 'api/orders/userAllergies/sendConsent';
        req = {
          user_id: this.patient.id,
          order_id: this.orderId,
          consent_message: this.consentForm.value.consentMsg
        ...
        api_url = 'api/orders/userBP/sendConsent';
        req = {
          user_id: this.patient.id,
          order_id: this.orderId,
          consent_message: this.consentForm.value.consentMsg
        ...
        api_url = 'api/orders/userBMI/sendConsent';
        req = {
          user_id: this.patient.id,
          order_id: this.orderId,
          consent_message: this.consentForm.value.consentMsg
